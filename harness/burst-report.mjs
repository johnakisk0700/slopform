...
<p>Παράχθηκε από <code>harness/burst-report.mjs</code>. Αυτόνομο αρχείο: κανένα εξωτερικό stylesheet, script ή γραμματοσειρά — ανοίγει από τον δίσκο και εκτός δικτύου.</p>
</footer>`;
}
