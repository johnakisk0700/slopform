...
import { ConversationPersistenceError } from "../../apps/backend/src/modules/conversations/conversation-persistence.errors.js";
...
} from "../../apps/backend/src/modules/post-event-feedback/post-event-feedback-conversation.repository.js";
import {
...
} from "../../apps/backend/src/modules/post-event-feedback/outbox/transport.js";
import type {
...
export function noopSummaries(): import("../../apps/backend/src/modules/post-event-feedback/summary/summary.service.js").PostEventFeedbackCampaignSummaryService {
  return {
    notifyIfLastConversationClosed: async () => undefined,
    recover: async () => ({ pending: 0, automatic: 0 }),
  } as unknown as import("../../apps/backend/src/modules/post-event-feedback/summary/summary.service.js").PostEventFeedbackCampaignSummaryService;
}
