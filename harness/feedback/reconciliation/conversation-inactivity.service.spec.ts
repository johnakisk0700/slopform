...
import { buildFeedbackConversationGoals } from "../../../apps/backend/src/modules/post-event-feedback/post-event-feedback-conversation.document.js";
...
describe("FeedbackConversationInactivityService", () => {
...
function createService(): {
  service: FeedbackConversationInactivityService;
  conversations: {
  ...
  return {
    service: new FeedbackConversationInactivityService(
