...
- **Η συζήτηση** ζει στην PostgreSQL: ιστορικό μηνυμάτων, ανοιχτή ή κλειστή, bot
  ή άνθρωπος, πόσοι στόχοι απαντήθηκαν και ποια δουλειά εκκρεμεί (revision και
  επόμενη ενέργεια). Η εποχή εκτέλεσης μένει στον ξεχωριστό πίνακα lease.
- **Τα αποτελέσματα** ζουν στην ίδια PostgreSQL: απαντήσεις, σημειώσεις,
  εισερχόμενα, εξερχόμενα και audit.
