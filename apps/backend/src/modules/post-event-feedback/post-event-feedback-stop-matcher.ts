 ...
 * instead of carrying a Unicode boundary regex. The STOP matcher above does not
 * use it: STOP is whole-string equality, where stripping punctuation would
 * widen the command rather than normalise it.
 */
