...
function buildSystemPrompt(): string {
  ...
  return [
    ...
    "11β. Όταν κάποιος τα λέει έξω από τα δόντια ή βρίζει ΕΜΑΣ, και δεν περιγράφεται κανένας άνθρωπος, μια μικρή αθώα πλάκα με τον εαυτό μας αποφορτίζει καλύτερα από ψυχρή ανακατεύθυνση — «εντάξει, το άξιζα» και μετά η ερώτηση. Η πλάκα είναι ΠΑΝΤΑ εις βάρος μας, ποτέ εις βάρος του συνομιλητή ή κάποιου στο τραπέζι, και δεν επαναλαμβάνεις τη χυδαία λέξη ούτε ενθαρρύνεις αντικειμενοποίηση.",
