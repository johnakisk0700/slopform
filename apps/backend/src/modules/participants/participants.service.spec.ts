import type { AppTransaction, ParticipantRow } from "@slopform/database";
    ...
    const historyRows: ParticipantEventHistoryRow[] = [
      {
        ...
        venueLabel: "Six Tables Athens",
        venueType: "restaurant",
        venueArea: "Pangrati",
        venuePriceLevel: "moderate",
        venuePriceStartMinor: 1_800,
        venuePriceEndMinor: 2_600,
