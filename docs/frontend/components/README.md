...
| Component                    | Owns                                                                                                                                                                                                                                                                                 |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `CampaignHeader.tsx`         | Two exports. `CampaignHeader` is the page's own chrome — back link, pause/resume/close actions, the `h1` with its six-dot mark. `CampaignContext` is the standing-facts row that sits with the summary card: the venue at one end, the exceptions at the other, nothing when neither |
